...
public class Account implements Bank {
	...
	@Override
	public synchronized void deposit(int amount) throws DepositLimitExceededException {
		if (amount>Bank.DEPOSIT_LIMIT)
			throw new DepositLimitExceededException("can't deposit "+amount+" as deposit limit exceeded..");
		balance+=amount;
	}
